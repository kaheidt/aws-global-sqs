param (
    ...
    [int]$PrimaryWeight = 10,  # Reversed from default to simulate failover
    [int]$SecondaryWeight = 90 # Reversed from default to simulate failover
)
...
# Update the stack with new weights
Write-Host "Updating Route53 weights: Primary=$PrimaryWeight, Secondary=$SecondaryWeight"
...
Write-Host "Failover toggle completed successfully!"